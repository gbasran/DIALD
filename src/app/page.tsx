...
export default function DashboardPage() {
  ...
  return (
    <div ref={containerRef} className="flex h-full flex-col animate-fade-in">
      {/* Header row */}
      ...
      <div className="grid min-h-0 flex-1 gap-2.5 grid-cols-[180px_1fr_1fr]">
        ...
        <div className="flex flex-col gap-2.5">
          {[
            ...
            <LiquidGlass key={s.title} {...glass} mouseContainer={containerRef}>
              <div className="p-3">
          ...
          {/* Activity — compact */}
          <LiquidGlass {...glass} mouseContainer={containerRef} className="flex-1">
        ...
        <div className="flex flex-col gap-2.5 min-h-0">
          {/* What Now */}
          <LiquidGlass {...glassStrong} mouseContainer={containerRef}>
            <div className="p-4">
          ...
          {/* Course Progress */}
          <LiquidGlass {...glass} mouseContainer={containerRef}>
            <div className="p-3.5">
          ...
          {/* Streak + Focus Time side by side */}
          <div className="grid min-h-0 flex-1 grid-cols-2 gap-2.5">
            {/* Streak */}
            <LiquidGlass {...glass} mouseContainer={containerRef} className="h-full">
        ...
        <div className="flex flex-col gap-2.5 min-h-0">
          ...
          {/* AI Insights */}
          <LiquidGlass {...glassStrong} mouseContainer={containerRef} className="flex-1">
            <div className="p-3.5 h-full flex flex-col">
